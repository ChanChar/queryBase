...
(function() { this.JST || (this.JST = {}); this.JST["comments/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<p class=\'body\'>',  comment.escape('body') ,'</p>\n<hr class=\'break\'>\n');}return __p.join('');};
}).call(this);
...
(function() { this.JST || (this.JST = {}); this.JST["navbar/navbar"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('\n  <nav class=\'top-bar\'>\n    <ul class="title-area">\n      <li class="name">\n        <h1><a href="#">queryBase</a></h1>\n      </li>\n    </ul>\n\n    <section class="top-bar-section">\n      <ul class="right">\n        <li><a href="session/new" class=\'sign-out\'>Sign Out</a></li>\n      </ul>\n    </section>\n  </nav>\n\n  <section class="row text-center menu-links">\n    <div class="small-12 small-centered columns">\n      <ul class="button-group subnav">\n        <li><a href="#" class=\'button small\'>Questions</a></li>\n        <li><a href="#tags" class=\'button small\'>Tags</a></li>\n        <li><a href="#users" class=\'button small\'>Users</a></li>\n        <li><a href="#badges" class=\'button small\'>Badges</a></li>\n        <li><a href="#unanswered" class=\'button small\'>Unanswered</a></li>\n        <li><a href="#questions" class=\'button small\' data-reveal-id=\'reveal-question-form\'>Ask a Question</a></li>\n      </ul>\n    </div>\n  </section>\n\n  <div id="reveal-question-form" class="reveal-modal" data-reveal aria-labelledby="reveal-question-form" aria-hidden="true" role="dialog">\n  </div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["questions/index-item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('\n<div class="row">\n    <a class="question-attr small-1 columns" href=\'#questions/',  question.id ,'\'>\n      <p class=\'text-center index-counter\'> ',  question.get('score') ,' </p>\n      <h6 class=\'subheader counter-text\'>Votes</h6>\n    </a>\n\n    <a class="answer-count small-1 columns" href=\'#questions/',  question.id ,'\'>\n      <p class=\'text-center answer-counter\'> ',  question.answers().length ,' </p>\n      <h6 class=\'answer-text\'>Answers</h6>\n    </a>\n    <a class="question-attr small-1 columns" href=\'#questions/',  question.id ,'\'>\n      <p class=\'text-center index-counter\'> ',  question.escape('views') ,' </p>\n      <h6 class=\'subheader counter-text\'>Views</h6>\n    </a>\n\n    <a class="small-9 columns" href=\'#questions/',  question.id ,'\'>\n      <p class=\'question-title\'>',  question.escape('title') ,'</p>\n    </a>\n\n    <div class="small-7 columns">\n      ');  tags.each(function (tag) { ; __p.push('\n        <a class=\'tag\' href=\'#tags/',  tag.escape('id') ,'\'>',  tag.escape('name') ,'</a>\n      ');  }) ; __p.push('\n    </div>\n\n    <a class="user-info right" href="#users/',  question.escape('asker_id') ,'">\n      ',  question.get('asker').email.slice(0, 10) ,'...</a>\n</div>\n\n<hr>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["questions/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<hr>\n<div class="question-index-items">\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["questions/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<form data-abide>\n\n  <a class="close-reveal-modal" aria-label="Close">&#215;</a>\n\n  <h3>Post your question</h3>\n  <hr>\n  <!-- title -->\n  <div class="row">\n    <div class="small-12 columns">\n      <div class="row">\n        <div class="small-1 columns">\n        <label class=\'space\'><small>.</small></label>\n        <label for="right-label" class="left inline">Title: </label>\n        </div>\n          <div class="small-11 columns left">\n            <label><small>required</small></label>\n            <input type="text" name=\'question[title]\' id="right-label" placeholder="Eg. What is a closure?" required>\n            <small class="error">Did you forget to ask a question?</small>\n          </div>\n      </div>\n    </div>\n  </div>\n\n  <!-- body  -->\n  <div class="row">\n    <div class="small-12 columns">\n      <label>Description:\n        <textarea placeholder=\'\' name=\'question[description]\'></textarea>\n      </label>\n    </div>\n  </div>\n\n  <!-- tags -->\n  <div class="row">\n    <div class="small-12 columns">\n      <label>Tags:\n        <input type="text" name=\'question[tag_list]\' placeholder="Eg. Javascript, Backbone.js" />\n      </label>\n    </div>\n  </div>\n\n  <!-- submit button -->\n  <div class="row">\n    <div class="small-3 columns left submit-buttons">\n      <input type=\'submit\' class=\'button success\' value=\'Post Question\'>\n    </div>\n    <div class="small-3 columns left submit-buttons">\n      <input type=\'submit\' class=\'button cancel\' value=\'Cancel\'>\n    </div>\n  </div>\n\n  <hr>\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["questions/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="row">\n\n  <div class="small-1 columns">\n    <div class="question-vote"></div>\n  </div>\n\n  <div class="small-11 columns">\n    <div class="question-details">\n      <h4>',  question.escape('title') ,'</h4>\n      <hr>\n\n      <div class="description">\n        <p>',  question.escape('description') ,'</p>\n      </div>\n\n      <div class="tags">\n        ');  tags.each(function (tag) { ; __p.push('\n          <a class=\'tag\' href=\'#tags/',  tag.escape('id') ,'\'>',  tag.escape('name') ,'</a>\n        ');  }) ; __p.push('\n      </div>\n\n      <div class="question-comments"></div>\n\n      <a class=\'show-comment-form\'>Add a comment</a>\n      <div class="new-question-comment hide"></div>\n\n      ');  var numQuestions = question.answers().length ; __p.push('\n        <h4 class><u>',  numQuestions ,' ',  pluralize('Answer', numQuestions) ,'</u></h4>\n    </div>\n  </div>\n</div>\n\n<div class="answers"></div>\n\n<div class="row">\n  <div class="small-11 columns small-offset-1 columns">\n    <h5>Your Answer</h5>\n    <div class="answer-form"></div>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
...
(function() { this.JST || (this.JST = {}); this.JST["tags/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="row">\n  <h3>Questions tagged with: <a class=\'tag-header\' href="#tags/',  tag.id ,'"> ',  tag.escape('name') ,' </a></h3>\n</div>\n\n<div class="questions-with-tag"></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["users/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');}return __p.join('');};
}).call(this);
...
QueryBase.Views.UsersIndex = Backbone.View.extend({
