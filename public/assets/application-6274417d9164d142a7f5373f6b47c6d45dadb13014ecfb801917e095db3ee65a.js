...
(function() { this.JST || (this.JST = {}); this.JST["answers/edit"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<form class=\'answer-edit\' data-abide>\n\n  <a class="close-reveal-modal" aria-label="Close">&#215;</a>\n  <hr>\n\n  <input type="hidden" name="answer[question_id]" value="',  answer.escape('question_id') ,'">\n\n  <!-- body  -->\n  <div class="row">\n    <div class="small-12 columns">\n      <label><small>*markdown supported</small></label>\n      <textarea class=\'edit-answer-description\'\n          name=\'answer[body]\'>',  answer.escape('body') || '' ,'</textarea>\n    </div>\n  </div>\n\n  <!-- body preview w/ markdown -->\n  <div class="row">\n    <div class="small-12 columns preview">\n      ',  marked(answer.get('body') || '') ,'\n    </div>\n  </div>\n\n  <!-- submit button -->\n  <div class="row">\n    <div class="small-3 columns left submit-buttons">\n      <input type=\'submit\' class=\'button success\' value=\'Update Answer\'>\n    </div>\n    <div class="small-3 columns left submit-buttons">\n      <input type=\'submit\' class=\'button cancel\' value=\'Cancel\'>\n    </div>\n  </div>\n\n  <hr>\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["answers/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="answer-index-items"></div>\n\n<div class="row">\n  <div class="small-11 columns small-offset-1 columns">\n    <h5>Your Answer</h5>\n    <div class="answer-form"></div>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["answers/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<input type="hidden" name="answer[question_id]" value="',  question.escape('id') ,'">\n\n<div class="row">\n  <div class="small-12 columns">\n    <label><small>*markdown supported</small></label>\n    <textarea class=\'new-answer-body\' name=\'answer[body]\'></textarea>\n  </div>\n</div>\n\n<div class="row">\n  <div class="small-12 columns preview">\n  </div>\n</div>\n\n<div class="row">\n  <div class="small-12 columns">\n    <input type=\'submit\' class="button small success" value=\'Post Answer\'>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["answers/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="row">\n  <div class="small-1 columns">\n    <div class="answer-vote"></div>\n  </div>\n\n  <div class="answer-item small-11 columns">\n\n    <div class="row">\n      <div class="small-12 columns answer-body">\n        ',  marked(answer.get('body') || '') ,'\n      </div>\n    </div>\n\n    <div class="row">\n      <div class="small-6 columns">\n        ');  if (answer.get('owned')) { ; __p.push('\n          <a class=\'answer-delete-link\'>Delete</a>\n          <a class=\'answer-edit-show\'>Edit</a>\n        ');  } ; __p.push('\n      </div>\n    </div>\n\n    <div class="answerer-info small-4 columns right">\n      <div class="row">\n\n        <div class="small-4 columns image-container">\n          ');  if (answer.get('answerer_image_url')) { ; __p.push('\n            <img class=\'answerer-image\' src="',  answer.get('answerer_image_url') ,'"/>\n          ');  } else { ; __p.push('\n            <img class=\'answerer-image\' src="http://placehold.it/75x75"/>\n          ');  } ; __p.push('\n        </div>\n\n        <div class="answerer-username small-8 columns left">\n          <a class="user-info" href="#users/',  answer.escape('answerer_id') ,'">\n          ',  answer.escape('answerer_username') ,'</a>\n          <p class=\'timestamp\'>answered ',  answer.escape('answered_at') ,' ago</p>\n        </div>\n\n      </div>\n    </div>\n\n    <div class="answer-comments small-12 columns"></div>\n\n    <a class=\'show-answer-comment-form\'>Add a comment</a>\n\n    ');  if (answer.get('question_owned')) { ; __p.push('\n      <!-- owner options -->\n      ');  if (answer.get('best')) { ; __p.push('\n        <a class=\'best-answer\'></a>\n      ');  } else { ; __p.push('\n        <a class="mark-best-link">Mark as best</a>\n      ');  } ; __p.push('\n\n    ');  } else { ; __p.push('\n      <!-- public view -->\n      ');  if (answer.get('best')) { ; __p.push('\n        <a class=\'best-answer\'></a>\n      ');  } ; __p.push('\n\n    ');  } ; __p.push('\n    <div class="new-answer-comment hide"></div>\n  <hr>\n  </div>\n</div>\n\n<div id="reveal-edit-answer-form" class="reveal-modal" data-reveal\n  aria-labelledby="reveal-edit-answer-form" aria-hidden="true" role="dialog">\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["badges/index-item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="badge-item">\n  <div class="row">\n\n    <div class="badge-details small-3 columns text-center">\n      <div class="row">\n        <img class=\'badge-image\' src="',  badge.escape('image_url') ,'"/>\n      </div>\n\n      <div class="row">\n        <h4 class=\'badge-title\'>',  badge.escape('title') ,'</h4>\n      </div>\n    </div>\n\n    <div class="small-6 columns left">\n      ');  if (badge.id === 1) { ; __p.push('\n        <h4>Awarded at sign up</h4>\n      ');  } else { ; __p.push('\n        <h4>Awarded at ',  badge.escape('value') ,' points</h4>\n      ');  } ; __p.push('\n      <p class=\'badge-description\'>',  badge.escape('description') ,'</p>\n    </div>\n  </div>\n</div>\n<hr>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["badges/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="row">\n  <h1>All Badges:</h1>\n<hr>\n</div>\n\n<div class="row">\n  <div class="badge-index-items"></div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["comments/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<!-- Only questions have answerer_ids -->\n\n');  if (model) { ; __p.push('\n  ');  if (model.escape('asker_id')) { ; __p.push('\n    <form class="question-comment-form">\n    <input type="hidden" name="question_id" value="',  model.id ,'">\n\n  ');  } else { ; __p.push('\n    <form class="answer-comment-form">\n    <input type="hidden" name="answer_id" value="',  model.id ,'">\n  ');  } ; __p.push('\n\n    <div class="row">\n      <div class="large-12 columns">\n        <textarea placeholder="" name=\'comment[body]\'></textarea>\n      </div>\n    </div>\n\n    <div class="row">\n      <div class="small-12 columns">\n        <input type=\'submit\' class="button tiny success" value=\'Post Comment\'>\n      </div>\n    </div>\n  </form>\n\n');  } ; __p.push('\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["comments/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<p class=\'body\'>\n\n  ',  comment.escape('body') ,' -\n\n  ');  if (comment.get('owned')) { ; __p.push('\n    <a class=\'comment-delete-link\'>Delete</a>\n  ');  } else { ; __p.push('\n    <a href="#users/',  comment.escape('commenter_id') ,'" class=\'commenter-name\'>\n      ',  comment.escape('commenter') ,'</a>\n  ');  } ; __p.push('\n\n\n</p>\n<hr class=\'break\'>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["landing/landing"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>Welcome to queryBase</h1>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["misc/about"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<a class="close-reveal-modal" aria-label="Close">&#215;</a>\n\n<div class="row about-logo">\n  <div class="small-10 columns small-offset-1 text-center">\n    <img class=\'navbar-logo\' src="http://res.cloudinary.com/charliecloud/image/upload/v1434860856/logo_11_lycarl.png"/>\n  </div>\n</div>\n\n<div class="row about-description">\n  <div class="small-10 small-offset-1 columns text-center">\n    <h1>queryBase</h1>\n    <p>\n      A Q&amp;A site made for students, aspiring developers and professionals to\n      discuss computer programming. Ask questions, get answers and earn points.\n    </p>\n  </div>\n</div>\n\n<div class="row about-get-started">\n  <div class="small-10 small-offset-1 columns text-center">\n    <button class="button success" name="button">Take the Tour</button>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["misc/empty_search"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="row">\n  <div class="small-6 small-offset-3 columns">\n    <h3>Your search returned no results...</h3>\n    <p>but you got a kitten</p>\n    <img src="http://placekitten.com/g/400/400"/>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["navbar/navbar"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('\n  <nav class=\'top-bar\'>\n    <ul class="title-area">\n      <li class="name">\n        <img class=\'navbar-logo\' src="http://res.cloudinary.com/charliecloud/image/upload/v1434856560/logo_10_kha8cm.png" alt="queryBase-logo"/>\n        <h1><a href="#">queryBase</a></h1>\n      </li>\n    </ul>\n\n    <section class="top-bar-section">\n      <ul class="right">\n        <li class=\'profile-button\'><a href="#users/',  user.id ,'">',  user.escape('username') ,'</a></li>\n        <li class=\'show-about-button\'><a href="#about">About</a></li>\n        <li class=\'signout-button\'><a href="session/new">Sign Out</a></li>\n      </ul>\n    </section>\n  </nav>\n\n  <section class="row text-center menu-links">\n    <div class="small-12 small-centered columns">\n      <ul class="button-group subnav">\n        <li><a href="#" class=\'button small questionIndex\'>Questions</a></li>\n        <li><a href="#tags" class=\'button small tagIndex\'>Tags</a></li>\n        <li><a href="#users" class=\'button small usersIndex\'>Users</a></li>\n        <li><a href="#badges" class=\'button small badgesIndex\'>Badges</a></li>\n        <li><a href="#unanswered" class=\'button small unansweredIndex\'>Unanswered</a></li>\n        <li id=\'ask-question\'><a class=\'button small show-question-form\'>Ask a Question</a></li>\n      </ul>\n    </div>\n  </section>\n\n  <div id="reveal-question-form" class="reveal-modal" data-reveal\n    aria-labelledby="reveal-question-form" aria-hidden="true" role="dialog">\n  </div>\n\n\n  <div id="reveal-about" class="reveal-modal" data-reveal\n    aria-labelledby="reveal-about" aria-hidden="true" role="dialog">\n  </div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["questions/edit"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<form class=\'question-edit\' data-abide>\n\n  <a class="close-reveal-modal" aria-label="Close">&#215;</a>\n\n  <!-- <h3>Update your question</h3> -->\n  <hr>\n  <!-- title -->\n  <div class="row">\n    <div class="small-12 columns">\n      <div class="row">\n        <div class="small-1 columns">\n        <label class=\'space\'><small>.</small></label>\n        <label for="right-label" class="left inline">Title: </label>\n        </div>\n          <div class="small-11 columns left">\n            <label><small>required</small></label>\n            <input type="text" class=\'edit-question-title\' name=\'question[title]\'\n              id="right-label" placeholder="Eg. What is a closure?"\n                value=\'',  question.escape('title') ,'\' required>\n            <small class="error">Did you forget to ask a question?</small>\n          </div>\n      </div>\n    </div>\n  </div>\n\n  <!-- body  -->\n  <div class="row">\n    <div class="small-12 columns">\n      <label><small>*markdown supported</small></label>\n      <textarea class=\'edit-question-description\'\n        placeholder=\'Eg. Could someone provide some useful examples of closures used in Javascript?\'\n          name=\'question[description]\'>',  question.escape('description') || '' ,'</textarea>\n    </div>\n  </div>\n\n  <!-- markdown guide -->\n\n\n  <!-- body preview w/ markdown -->\n  <div class="row">\n    <div class="small-12 columns preview">\n      ',  marked(question.get('description') || '') ,'\n    </div>\n  </div>\n\n  <!-- tags -->\n  <div class="row">\n    <div class="small-12 columns">\n      <label>Tags:\n        <input type="text" class=\'edit-question-tags\' name=\'question[tag_list]\'\n          value=\'',  tags ,'\' placeholder="Eg. Javascript, Backbone.js" />\n      </label>\n    </div>\n  </div>\n\n  <!-- submit button -->\n  <div class="row">\n    <div class="small-3 columns left submit-buttons">\n      <input type=\'submit\' class=\'button success\' value=\'Update Question\'>\n    </div>\n    <div class="small-3 columns left submit-buttons">\n      <input type=\'submit\' class=\'button cancel\' value=\'Cancel\'>\n    </div>\n  </div>\n\n  <hr>\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["questions/index-item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="row">\n\n    <a class="question-attr small-1 columns hide-for-small-only" href=\'#questions/',  question.id ,'\'>\n      <p class=\'text-center index-counter\'> ',  question.escape('score') ,' </p>\n      <h6 class=\'subheader counter-text\'>Votes</h6>\n    </a>\n\n    <a class="answer-count small-1 columns" href=\'#questions/',  question.id ,'\'>\n      <p class=\'text-center answer-counter\'> ',  question.answers().length ,' </p>\n      <h6 class=\'answer-text\'>',  pluralize ('Answer', question.answers().length) ,'</h6>\n    </a>\n\n    <a class="question-attr small-1 columns hide-for-small-only" href=\'#questions/',  question.id ,'\'>\n      <p class=\'text-center index-counter\'> ',  question.escape('views') ,' </p>\n      <h6 class=\'subheader counter-text\'>Views</h6>\n    </a>\n\n    <a class="small-9 columns" href=\'#questions/',  question.id ,'\'>\n      <p class=\'question-title\'>',  question.escape('title') ,'</p>\n    </a>\n\n    <div class="small-4 columns">\n      ');  tags.each(function (tag) { ; __p.push('\n        <a class=\'tag\' href=\'#tags/',  tag.escape('id') ,'\'>',  tag.escape('name') ,'</a>\n      ');  }) ; __p.push('\n    </div>\n\n    <div class="small-4 columns timestamp">\n      asked ',  question.escape('asked_at') ,' ago\n      <a class="user-info" href="#users/',  question.escape('asker_id') ,'">\n        ',  question.get('asker').username ,'</a>\n    </div>\n</div>\n\n<hr>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["questions/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('\n<hr>\n<div class="small-4 columns question-search-box" id=\'question-search-box\'>\n  <input type="text" name="name" class=\'questions-search\' placeholder="Search Questions">\n</div>\n<hr>\n\n<div class="question-index-items" id=\'questions-index\'>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["questions/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<form class=\'new-question-form\' data-abide>\n\n  <a class="close-reveal-modal" aria-label="Close">&#215;</a>\n\n  <!-- <h3>Post your question</h3> -->\n  <hr>\n  <!-- title -->\n  <div class="row">\n    <div class="small-12 columns">\n      <div class="row">\n        <div class="small-1 columns">\n        <label class=\'space\'><small>.</small></label>\n        <label for="right-label" class="left inline">Title: </label>\n        </div>\n          <div class="small-11 columns left">\n            <label><small>required</small></label>\n            <input type="text" class=\'new-question-title\' name=\'question[title]\' id="right-label" placeholder="Eg. What is a closure?" required>\n            <small class="error">Did you forget to ask a question?</small>\n          </div>\n      </div>\n    </div>\n  </div>\n\n  <!-- body  -->\n  <div class="row">\n    <div class="small-12 columns">\n      <label><small>*markdown supported</small></label>\n      <textarea class=\'new-question-description\' placeholder=\'Eg. Could someone provide some useful examples of closures used in Javascript?\' name=\'question[description]\'></textarea>\n    </div>\n  </div>\n\n  <!-- markdown guide -->\n\n\n  <!-- body preview w/ markdown -->\n  <div class="row">\n    <div class="small-12 columns preview">\n    </div>\n  </div>\n\n  <!-- tags -->\n  <div class="row">\n    <div class="small-12 columns">\n      <label>Tags:\n        <input type="text" class=\'new-question-tags\' name=\'question[tag_list]\' placeholder="Eg. Javascript, Backbone.js" />\n      </label>\n    </div>\n  </div>\n\n  <!-- submit button -->\n  <div class="row">\n    <div class="small-3 columns left submit-buttons">\n      <input type=\'submit\' class=\'button success\' value=\'Post Question\'>\n    </div>\n    <div class="small-3 columns left submit-buttons">\n      <input type=\'submit\' class=\'button cancel\' value=\'Cancel\'>\n    </div>\n  </div>\n\n  <hr>\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["questions/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="row top-space">\n\n  <div class="small-1 columns">\n    <div class="question-vote"></div>\n  </div>\n\n  <div class="small-11 columns">\n    <div class="question-details">\n      <h4>',  question.escape('title') ,'</h4>\n      <hr>\n\n      <div class="description">\n        <p>',  marked(question.get('description') || '') ,'</p>\n      </div>\n\n      <!-- <div class="row"> -->\n      <div class="small-7 columns">\n        <div class="tags row">\n          ');  tags.each(function (tag) { ; __p.push('\n            <a class=\'tag\' href=\'#tags/',  tag.escape('id') ,'\'>',  tag.escape('name') ,'</a>\n          ');  }) ; __p.push('\n        </div>\n      </div>\n\n      <div class="asker-info small-5 columns right">\n        <div class="row asker-info-row">\n\n          <div class="small-4 columns asker-image-container">\n            ');  if (question.get('asker').image_url) { ; __p.push('\n              <img class=\'asker-image right\' src="',  question.get('asker').image_url ,'"/>\n            ');  } else { ; __p.push('\n              <img class=\'asker-image right\' src="http://placehold.it/75x75"/>\n            ');  } ; __p.push('\n          </div>\n\n          <div class="small-8 columns timestamp-container left">\n            <a class="user-info" href="#users/',  question.escape('asker_id') ,'">\n            ',  question.get('asker').username ,'</a>\n            <p class=\'timestamp\'>asked ',  question.escape('asked_at') ,' ago</p>\n          </div>\n\n        </div>\n      </div>\n\n      <div class="small-7 columns">\n        <div class="owner-links row">\n          ');  if (question.get('owned')) { ; __p.push('\n            <a class=\'edit-link edit-question-form\'>Edit</a>\n            <a class=\'delete-link\'>Delete</a>\n          ');  } ; __p.push('\n          <strike><a class=\'share-link\'>Share</a></strike>\n        </div>\n      </div>\n\n      <hr>\n      <div class="question-comments"></div>\n\n      <a class=\'show-comment-form\'>Add a comment</a>\n      <div class="new-question-comment hide"></div>\n\n      <h5 class=\'num-answers\'>',  answers.length ,' ',  pluralize('Answer', answers.length) ,'</h5>\n    </div>\n  </div>\n</div>\n\n<div class="answers"></div>\n\n<div id="reveal-edit-question-form" class="reveal-modal" data-reveal\n  aria-labelledby="reveal-edit-question-form" aria-hidden="true" role="dialog">\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["questions/unanswered-index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<hr>\n<div class="unanswered-index-items"></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["tags/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="row">\n  <h1>All Tags:</h1>\n  <hr>\n<ul class=\'inline-list\'>\n\n  ');  tags.each(function (tag) { ; __p.push('\n    <li class=\'left\'>\n      <a class=\'tag-index-item\' href="#tags/',  tag.escape('id') ,'">\n        ',  tag.escape('name') ,'\n      </a>\n    </li>\n  ');  }) ; __p.push('\n  </ul>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["tags/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="row">\n  <h2>Questions tagged with: <a class=\'tag-header\' href="#tags/',  tag.id ,'"> ',  tag.escape('name') ,' </a></h2>\n  <hr>\n</div>\n\n\n<div class="questions-with-tag"></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["users/index-item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="row user-info">\n\n  <div class="small-4 columns text-center">\n    ');  if (user.escape('image_url')) { ; __p.push('\n      <img src="',  user.escape('image_url') ,'" class="profile-image">\n    ');  } else { ; __p.push('\n      <img src="http://placehold.it/100x100" class="profile-image">\n    ');  } ; __p.push('\n  </div>\n\n  <div class="small-8 columns">\n    <div class="row">\n      <h5 class=\'username\'>',  user.escape('username') ,'</h5>\n    </div>\n    <div class="row inline-list">\n      <li class=\'user-points\'>Points: ',  user.escape('points') ,'</li>\n      <li class=\'user-badge-number\'>Badges: ',  user.escape('num_badges') ,'</li>\n    </div>\n  </div>\n</div>\n<hr>\n<div class="row">\n  <ul class=\'inline-list user-badges\'>\n    ');  user.earned_badges().each(function (badge) { ; __p.push('\n      <li><a href="#badges"><img class=\'earned-badge-item\' src="',  badge.escape('image_url') ,'"></a></li>\n    ');  }); ; __p.push('\n  </ul>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["users/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<!-- add padding top -->\n\n<hr>\n<div class="small-4 columns user-search-box">\n  <input type="text" name="name" class=\'user-search\' placeholder="Search Users">\n</div>\n<hr>\n\n<ul class="small-block-grid-1 large-block-grid-3 user-index-items"></ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["users/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<hr>\n<div class="row user-page-info">\n  <div class="small-4 columns text-center">\n    <img src="',  user.escape('image_url') ,'" class="profile-image-show">\n\n    ');  if (user.get('owned')) { ; __p.push('\n      <div class=\'change-photo-link\'>Update Profile Picture</div>\n    ');  } ; __p.push('\n\n  </div>\n\n  <div class="small-8 columns">\n    <div class="row">\n      <h2 class=\'username\'>',  user.escape('username') ,'</h2>\n    </div>\n\n    <div class="user-stats">\n      <div class="row">\n        <div class=\'user-question-points\'>Question Score: ',  user.escape('question_points') ,'</div>\n        <div class=\'user-answer-points\'>Answer Score: ',  user.escape('answer_points') ,'</div>\n      </div>\n      <div class="row">\n        <p class=\'user-badge-number\'>Number of Badges: ',  user.escape('num_badges') ,'</p>\n      </div>\n    </div>\n\n  </div>\n</div>\n<div class="row">\n  <hr>\n  <ul class=\'inline-list earned-user-badges\'>\n    ');  user.earned_badges().each(function (badge) { ; __p.push('\n      <li><a href=\'#badges\'><img class=\'earned-badge\' src="',  badge.escape('image_url') ,'"></a></li>\n    ');  }); ; __p.push('\n  </ul>\n</div>\n\n<div class="row">\n  <hr>\n  ');  if (questions.length === 0 ) { ; __p.push('\n    <div class="zero-questions">\n      <h3>You haven\'t asked any questions yet.</h3>\n    </div>\n  ');  } else { ; __p.push('\n    <div class="asked-questions"></div>\n  ');  } ; __p.push('\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["votes/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="row">\n\n<div class=\'upvote-button\'></div>\n\n<div class="row">\n  <div class="vote-count text-center"><h3>',  model.get('score') ,'</h3></div>\n</div>\n\n<div class="row">\n  <div class=\'downvote-button\'></div>\n</div>\n');}return __p.join('');};
}).call(this);
//
...
QueryBase.Models.Vote = Backbone.Model.extend({
  urlRoot: 'api/votes'
});
